...
### [Migration Standards & Deliverables](migration-standards.md)
...
| ------- | --------------------------------------------------------------- | ---------------------------------------------- |
| DroneCI | [DroneCI to GitHub Actions Mapping](actions-mapping/droneci.md) | Commands, triggers, and configuration mappings |
...
| ------- | ------------------------------------------------ | -------------------------------------------------------- |
| DroneCI | [Secrets Migration](patterns/droneci/secrets.md) | Migrating secrets and environment variables from DroneCI |
...
| ------- | ------------------------------------------------------ | ----------------------------------------- |
| DroneCI | [DroneCI Migration Report](report-template/droneci.md) | Complete migration documentation template |
