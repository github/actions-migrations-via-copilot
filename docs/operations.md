...
The batch migration system uses **custom properties** to track and control migrations. Because there is no API to send a prompt to a custom agent directly, we use issues as prompts for Copilot to process:
